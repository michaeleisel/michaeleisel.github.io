...
**TL;DR: lld on the Mac can link binaries in 50-80% the time of ld64. It has come a long way and is now used by many large companies. Steps on how to integrate are in the [section](#integrating-lld) below.**
