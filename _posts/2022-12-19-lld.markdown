...
**TL;DR: lld is a great choice for faster linking of iOS, macOS, etc. debug binaries. It finishes in 50-80% the time of ld64 and is now used by many large companies. Steps on how to integrate are in the [section](#integrating-lld) below.**
