...
And while we're at it, consider switching to HTTP/3 if you haven't, because that can also be an easier way to improve networking performance than shared dictionary compression ([WWDC tutorial](https://developer.apple.com/videos/play/wwdc2021/10094/)).
